  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('sendMoney')}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={styles.confirmButton} onPress={() => navigation.navigate('pinConfirmation')}>
