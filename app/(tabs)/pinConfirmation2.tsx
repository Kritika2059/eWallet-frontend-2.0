    ...
    >
      <View style={styles.contentContainer}>
        <View style={styles.header}>
          <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('confirmation2')}>
        ...
        <View style={styles.content}>
          ...
          <TextInput
            ...
            onChangeText={setPin}
          />
          <TouchableOpacity style={styles.confirmButton} onPress={() => navigation.navigate('successfulLoad')}>
